...
import {FILTER_BY_HIGH_DEFENSE,FILTER_BY_MIN_DEFENSE ,FILTER_BY_HIGH_WEIGHT, FILTER_BY_MIN_WEIGHT ,FILTER_BY_HIGH_HP, FILTER_BY_MIN_HP ,SET_POKEMONS_TYPE_RENDER, GET_POKEMONS_TYPE,ADD_POKEMONS, SET_ORDER_A_Z, SET_ORDER_Z_A, FILTER_BY_ATTACK_MIN_MAX, FILTER_BY_ATTACK_MAX_MIN, GET_POKEMON_PER_NAME, ORDER_DEFAULT, SHOW_DB_POKEMONS, FILTER_BY_MIN_SPEED, FILTER_BY_HIGH_SPEED, ADD_POKEMONS_API} from './Types'
